...
public class MultiplayerManager : MonoBehaviour
{
    ...
    //intiializing UGS. Used to do this as a seperate script but figured out u just need to do it once lol,
    private async Task InitializeServices()
    {
        ...
        //sign in anonymously, im using my own login and I dont need Unitys
